  ...
  private buildForm() {
    this.formulaire = this.formBuilderService
      ...
      .addInput('plat', new ConfigInputBuilder()
        .addOption('input', { nameLabel: 'Plat', dataSource: { type: DataSourceType.BRUTE, value: [{ value: "hamburger", viewValue: "Hamburger Vegi" }, { value: "pizza", viewValue: "Pizza" }, { value: "quiche", viewValue: "Quiche" }] } })
      ...
      .addInput('prenom', new ConfigInputBuilder()
        .addOption('input', { nameLabel: 'Prénom' })
        .addOption('type', InputComponents.INPUT_TEXT))
      ...
      .addInput('zone', new ConfigInputBuilder()
        .addOption('input', { nameLabel: 'Zone' })
